...
Physical Curve("OUTFLOW")   = {14};
Physical Curve("SIDE")      = {13};
Physical Curve("WALL_IN")   = {5};
Physical Curve("WALL1")     = {6, 7, 8};
Physical Curve("SYMMETRY")  = {11, 15, 54, 55, 56};
Physical Curve("ELECTRODE_BODY") = {21};
Physical Curve("ELECTRODE") = {22};
